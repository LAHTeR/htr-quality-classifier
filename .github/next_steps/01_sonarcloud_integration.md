...
In order to configure Sonarcloud analysis [GitHub Action workflow](git@github.com:laHTeR/htr-quality-classifier/blob/main/.github/workflows/sonarcloud.yml) you must follow the steps below:
