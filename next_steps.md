...
git branch -M main
git remote add origin git@github.com:laHTeR/htr-quality-classifier
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/laHTeR/repositories/new](https://github.com/organizations/laHTeR/repositories/new)
and create a new repository named `htr-quality-classifier` as an empty repository, then push your commits to GitHub:
